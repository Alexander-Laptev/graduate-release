                                    ...
                                    @if($loop->first)
                                        <div class="mt-4 rounded-t-lg border border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                                            ...
                                            <div id="collapse{{ $record->id }}" class="!visible hidden" data-te-collapse-item aria-labelledby="heading{{ $record->id }}">
                                                <div class="grid grid-cols-2 justify-center rounded-md">
                                                    ...
                                                    <div class="self-center justify-self-end">
                                                        <button type="submit" class="mx-4 px-4 py-2 bg-red-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-600 focus:bg-red-600 active:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                                            {{ __('Отменить запись') }}
                                                        </button>
                                                    </div>
                                                </div>
