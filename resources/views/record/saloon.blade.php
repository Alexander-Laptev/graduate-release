                            ...
                            <div class="mt-4 grid grid-cols-3 gap-4 place-items-stretch">
                                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <button type="submit" value="{{ $saloon->id }}" id="saloon_id" name="saloon_id" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            {{ __('Выбрать') }}
                                        </button>
                                    </div>
                                </div>
